...
export default function HeroSection({ activeTab }: HeroSectionProps) {
    ...
    return (
        ...
        >
            ...
            {/* iPad image — personal tab only */}
            {activeTab === "personal" && (
                <div className="hero-personal-ipad" style={{ flexShrink: 0, width: "340px", height: "340px", position: "relative" }}>
                    <Image
                        src="/images/Apple-ipad-a16.png"
                        alt="Apple iPad A16"
                        fill
                        priority
                        sizes="340px"
